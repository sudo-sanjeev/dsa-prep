...
| --- | ----------------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Number of provinces                       | Medium     | [547. Number of Provinces](https://leetcode.com/problems/number-of-provinces/)                                                                                                                     |
| 2   | Connected Components Problem in Matrix    | Medium     | [200. Number of Islands](https://leetcode.com/problems/number-of-islands/) (count connected components of `1`s)                                                                                    |
...
| 12  | Number of islands                         | Medium     | [200. Number of Islands](https://leetcode.com/problems/number-of-islands/)                                                                                                                         |
