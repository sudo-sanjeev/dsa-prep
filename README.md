...
**Sheet rows solved:** **41** / **338** — same ✓ total as the table below (auto-updated by `add_solution.py` / `sync_progress.py`).
...
| -- | ------------------- | -------- | ----- | ----------------------------------------------- |
| 01 | Binary Search | 5 | 33 | [View](./01-binary-search/README.md) |
