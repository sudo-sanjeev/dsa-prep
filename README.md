...
**Sheet rows solved:** **56** / **338** — same ✓ total as the table below (auto-updated by `add_solution.py` / `sync_progress.py`).
...
| 08 | Binary Trees | 4 | 39 | [View](./08-binary-trees/README.md) |
