...
**Sheet rows solved:** **68** / **338** — same ✓ total as the table below (auto-updated by `add_solution.py` / `sync_progress.py`).
...
| 02 | Linked List | 6 | 31 | [View](./02-linked-list/README.md) |
