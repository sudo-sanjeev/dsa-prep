...
**Sheet rows solved:** **42** / **338** — same ✓ total as the table below (auto-updated by `add_solution.py` / `sync_progress.py`).
...
| 08 | Binary Trees | 1 | 39 | [View](./08-binary-trees/README.md) |
